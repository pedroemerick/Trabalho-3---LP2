...
public class Herring extends Fish {
	 ...
	 * 
	 * @param step
	 *            counter that should be incremented for each call. Used to avoid
	 *            the same fish acting more than once in a cycle
	 */
	...
	// public void move (Cell bestNeighbour, List <Cell> neighborhood, int
	// cell_atual) {
